...
import network.bahn.androidcryptowallet.ui.bitcoin.setup.BitcoinMnemonicWordGrid
...
@Composable
fun EthereumCreateWalletScreen(
    words: List<String>,
    passphrase: String,
...
@Composable
private fun EthereumCreateWalletScreenPreview() {
    WalletTheme {
