...
private val WalletLightColorScheme = lightColorScheme(
    ...
    primaryContainer = WalletGreyContainer,
    onPrimaryContainer = WalletOnBackground,
    secondary = WalletBlue,
    onSecondary = Color.White,
    secondaryContainer = WalletGreyContainer,
    onSecondaryContainer = WalletOnBackground,
    ...
    surfaceContainerLowest = WalletBackground,
    surfaceContainerLow = WalletSurfaceVariant,
    surfaceContainer = WalletSurfaceVariant,
    surfaceContainerHigh = WalletGreyContainer,
    surfaceContainerHighest = WalletGreyContainer,
